...
export function VerticalLauncher({ onOpen, onClose, isMobile }: VerticalLauncherProps) {
    return (
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col gap-[11px]">
                    ...
                    <div className="flex items-center gap-[3px]">
                        <span className={`font-semibold text-gray-900 tracking-tight whitespace-nowrap leading-none ${isMobile ? 'text-[12px]' : 'text-[13px]'}`}>
                            TrustHire
                        </span>
            ...
            {/* Arrow Tab */}
            <div className={`flex items-center justify-center bg-white rounded-r-[11px] shadow-[2px_0_8px_rgba(0,0,0,0.08)] z-[-1] -ml-[18px] pl-[18px]
                ${isMobile ? 'w-[36px] h-[29px]' : 'w-[43px] h-[36px]'}`}
            >
